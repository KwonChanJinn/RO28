...
public class Program {
    public static void main(String[] args) {
        ...
        pos1.positionId = 1;
        pos1.PositionName = EnumTypeQuestion.EnumPosition.PM;

        Position pos2 = new Position();
        pos2.positionId = 2;
        pos2.PositionName = EnumTypeQuestion.EnumPosition.DEV;

        Position pos3 = new Position();
        pos3.positionId = 3;
        pos3.PositionName = EnumTypeQuestion.EnumPosition.TEST;

        Position pos4 = new Position();
        pos4.positionId = 4;
        pos4.PositionName = EnumTypeQuestion.EnumPosition.SCRUM_MASTER;
        ...
        qs1.typeID = ty1;
        qs1.creatorId = ca1;
        qs1.createDate = new java.sql.Date(2020 - 2 - 1);
